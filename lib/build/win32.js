...
const BuildWin32Binary = (path, binaryDir, version, platform, arch, {
    ...
    Flow(function*(cb) {
        ...
        if(sideBySide) {
            ...
            let [err, nwFile] = yield NWB.util.ZipDirectory(workDir, [], join(buildDir, 'app.nw'), cb.expect(2));
        ...
        // FIXME: GUARD Editing executable will cause the combined application fails to load.
        if(sideBySide) {
