        ...
        for(let target of options.targets) {
            ...
            case 'win32':

                {
                    ...
                    let [err, path] = yield NWB.BuildWin32Binary(options.path, binaryDir, NWD.GetTarget(platform, arch), {}, cb.expect(2));
            ...
            case 'linux':

                {
                    ...
                    let [err, path] = yield NWB.BuildLinuxBinary(options.path, binaryDir, NWD.GetTarget(platform, arch), {}, cb.expect(2));
            ...
            case 'darwin':

                {
                    ...
                    let [err, path] = yield NWB.BuildDarwinBinary(options.path, binaryDir, NWD.GetTarget(platform, arch), {}, cb.expect(2));
